...
The Craft CMS 3.x version of this plugin can be found here: [craft-richvariables](https://github.com/nystudio107/craft-richvariables) and can also be installed via the Craft Plugin Store in the Craft CP.
